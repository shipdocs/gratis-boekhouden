          ...
          <div className="card">
            ...
            <table className="sumtable">
              <tbody>
                ...
                {r.summary.btwVerlegd !== 0 && <tr><td>Btw die een onderaannemer naar jou verlegde (je betaalt hem en krijgt hem tegelijk terug: kost je niets)</td><td><Euro cents={r.summary.btwVerlegd} /></td></tr>}
